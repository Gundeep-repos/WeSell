...
public final class user_005fhome_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (email == null) {
      ...
      out.write("                {\n");
      out.write("                    xhr.open(\"GET\", \"./UserChangePassword?old_pass=\" + old_pass + \"&new_pass=\" + new_pass, true);\n");
      ...
      out.write("                    document.getElementById(\"label3\").className = \"glyphicon glyphicon-ban-circle\";\n");
      out.write("                    document.getElementById(\"label3\").style.color = \"red\";\n");
      out.write("                } else\n");
      out.write("                {\n");
      ...
      out.write("                        document.getElementById(\"label3\").className = \"glyphicon glyphicon-ok\";\n");
      out.write("                        document.getElementById(\"label3\").style.color = \"green\";\n");
      out.write("                    } else\n");
      out.write("                    {\n");
      out.write("                        flag = 1;\n");
      ...
      out.write("                document.getElementById(\"label3\").className = \"\";\n");
      out.write("            }\n");
      ...
      out.write("\n");
      out.write("                var xhr = new XMLHttpRequest;\n");
      out.write("                xhr.open(\"GET\", \"./UserLogout\", true);\n");
      out.write("                xhr.onreadystatechange = function ()\n");
      out.write("                {\n");
      out.write("\n");
      out.write("                    if (xhr.status === 200 && xhr.readyState === 4)\n");
      ...
      out.write("                        {\n");
      out.write("                            alert(\"Logout Successful\");\n");
      ...
      out.write("            </div>\n");
      out.write("            <div class=\"row\">\n");
      out.write("                <a href=\"user_addproducts.jsp\">Sell Products</a>\n");
      out.write("            </div>\n");
      out.write("            <div class=\"row\">\n");
      out.write("                <a href=\"user_manageproducts.jsp\">Manage Products</a>\n");
      out.write("            </div>\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      out.write("            <div class=\"row\">\n");
      out.write("                <a href=# onclick=\"userlogout()\">Logout</a>\n");
      out.write("            </div>\n");
      ...
      out.write("                                    <label class=\"\" id=\"label3\" style=\"font-size: 15px\"></label>\n");
