...
public class SimpleMailDemo {
    ...
    String port = "587";
    String mailFrom = "wesell.website.123@gmail.com";
    String password = "12345abc6789";
    ...
    public static void main(String[] args) {
        ...
        SimpleMailDemo obj = new SimpleMailDemo("gundeep5830@gmail.com", "hello", "testing mail");
    }
}